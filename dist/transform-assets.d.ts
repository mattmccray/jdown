...
export declare const minify: (paths: string[], options: AssetOptions) => Promise<imagemin.Result[]>;
export declare const assetPaths: (dir: string, files: Files) => string[];
export declare const output: (contentDirectory: string, outputDirectory: string, outputPath: string, assets: imagemin.Result[]) => Promise<Asset[]>;
export declare const rewriteAssetPaths: (files: Files, assets: Asset[], contentDirectory: string) => Files;
/**
