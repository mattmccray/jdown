...
const transform_buffer_to_string_1 = __importDefault(require("./transform-buffer-to-string"));
...
const jdown = (dir, options = defaultOptions) => {
    ...
    if (options.assets) {
        content.use(transform_assets_1.default(dir, Object.assign({}, defaultAssetOptions, options.assets)));
    }
